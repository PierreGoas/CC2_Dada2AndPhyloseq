...
echantillon <- substr(subject,10,100)
subject <- substr(subject,1,999)
date <- as.integer(sapply(strsplit(samples.out, "D"), `[`, 2))
profondeur <- substr(subject,7,15)
...
```{r}
plot_richness(ps, x="Year", measures=c("Shannon", "Simpson"), color="When")
```
